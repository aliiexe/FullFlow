      ...
      if (y > prevY.current) {
        ...
        squareTimer.current = setTimeout(() => {
          ...
          circleTimer.current = setTimeout(() => {
            ...
            stage2Timer.current = setTimeout(() => setStage2(true), 100);
          }, 50);
        }, 400);
      } else {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              setCollapsed(false);
              // Show content only after expansion is complete
    ...
    <header className={`navbar-fixed ${desktopNavClasses} ${mobileNavClasses}`}>
      ...
      <nav className={`navbar-content ${navbarContentClasses}`}>
        ...
        {(!isMobile && (!collapsed || open)) ? (
          <>
            <div className={`navbar-logo  ${contentVisible ? 'content-visible' : 'content-hidden'}`}>FullFlow</div>
            <ul className={`navbar-menu ${contentVisible ? 'content-visible' : 'content-hidden'}`}>
              <li><a href="#">Services</a></li>
              <li><a href="#">Features</a></li>
              <li><a href="#">Pricing</a></li>
              <li><a href="#">Blog</a></li>
            </ul>
            <div className={`navbar-actions ${contentVisible ? 'content-visible' : 'content-hidden'}`}>
