...
export default function Dashboard() {
    ...
    deliverables: [
      {
        ...
        price: 199,
        description: "Static data example deliverable",
      },
    ],
  };
  ...
  const handleCancelSubscription = async () => {
    // No actual subscription logic here—static only
    setError("Canceled subscription is not implemented in static mode.");
  };
            ...
            <div className="px-4 py-5 sm:px-6">
              <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                <div className="sm:col-span-1">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">
                    {projectDetails?.subscription?.name || "N/A"}
                  </dd>
                </div>
                <div className="sm:col-span-1">
                  <dt className="text-sm font-medium text-gray-500">Price</dt>
                  <dd className="mt-1 text-sm text-gray-900">
                    ${projectDetails?.subscription?.amount}/month
                  </dd>
                </div>
                <div className="sm:col-span-1">
                ...
                <div className="sm:col-span-2">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">
                    {new Date(
                      projectDetails?.subscription?.currentPeriodStart
                    ).toLocaleDateString()}{" "}
                    -{" "}
                    {new Date(
