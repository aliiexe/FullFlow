...
const ProofElementsSection = () => {
  ...
  const portfolioItems = [
    ...
    },
    {
      id: "item3",
      type: "video",
      image: "/images/portfolio/thumbnail1.png",
      alt: "Video Thumbnail 1",
      videoSrc: "/videos/proofvid2.mp4",
      layout: "regular",
      row: 2,
    },
    {
    ...
    },
    {
      id: "item6",
      type: "video",
      image: "/images/portfolio/thumbnail2.png",
      alt: "Video Thumbnail 2",
      videoSrc: "/videos/vidproof1.mp4",
      layout: "regular",
      row: 3,
    },
    {
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-xl text-zinc-300 max-w-3xl mx-auto">
            Explore our case studies, demonstrations, and client success stories
            that highlight our expertise and results.
          </p>

          <Link
            href="/documents/fullflow-folio.pdf"
            target="__blank"
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="bg-white/5 backdrop-blur-[3px] p-5 rounded-full transition-transform duration-300 hover:scale-110">
                              <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
